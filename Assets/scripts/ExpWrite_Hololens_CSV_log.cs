...

    {
        ...
        async Task MakeNewSession()
        {
            ...
            string rootPath = "";
                    ...
                    StorageFile DataWritetoFile = await sessionParentFolder.CreateFileAsync("test_data.csv");
...
>>>>>>> parent of 5d3a684 (final)
        ...
        private void Add_Row_CSV(List<String> rowData)
        {
